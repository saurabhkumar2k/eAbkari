...
export default function ApplicantDetails({ formData, onChange, errors = {}, title = "Pre-filed Registered Profile Information", description = "These applicant details are loaded automatically from your online registry records. You can review and verify the demographic, residential, and verification fields." }) {
  return (
    <div className="hcr-applicant-container animate-fade text-left">
      ...
      <div className="info-banner">
        ...
        <div>
          <h4 className="info-banner-title">{title}</h4>
