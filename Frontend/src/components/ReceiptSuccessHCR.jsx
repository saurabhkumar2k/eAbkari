    ...
    <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
        ...
        <div className="bg-slate-50 rounded-2xl border p-5">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <h4 className="font-bold text-lg mt-1">{siteForm?.SiteName}</h4>
            </div>
          </div>
        </div>
      ...
      <div className="mt-10">
        <div className="flex items-center justify-center gap-4 mb-7">
          ...
          <h3 className="text-2xl font-bold text-slate-800">Applied Licence</h3>
          ...
          <div className="inline-flex items-center gap-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl px-8 py-5 shadow-md hover:shadow-lg transition-all">
            ...
            <div>
              ...
              <h4 className="text-lg font-bold text-slate-800 mt-1">
                {/* {selectedLicenseDetails?.licenseeCatCode} -{" "} */}
                {selectedLicenseDetails?.licenseeCatDesc}
              </h4>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-2 leading-7">
                Your application has been submitted successfully. It has been
                forwarded for verification. You can track the application status
