      ...
      items: [
        ...
        { id: "director_change", label: "Director Change" },
        {
          ...
          sideItems: [
            ...
            {
              id: "act_on_new_license_application",
              label: "Act on New License Application",
            },
          ],
        },
      ],
      ...
      items: [
        {
          ...
          hasSideMenu: true,
          sideItems: [{ id: "user_profile", label: "User Profile" }],
        },
      ],
    },
    {
          ...
          <div className="dept-dash-brand-row da-header-brand-row">
            <div className="dept-dash-logo-block da-header-logo-block">
              ...
              <div className="dept-dash-titles da-header-title-group">
                <h1 className="dept-main-title da-header-dept-title caps">
                  DEPARTMENT OF EXCISE
                </h1>
                <p className="dept-sub-title da-header-dept-sub semibold">
            ...
            <div className="dept-dash-right-actions da-header-user-info">
              <div className="dept-user-profile-pill da-user-badge-box">
                ...
                <div className="dept-user-info-text">
                  <span className="dept-user-role da-user-role-tag">
                    LOGGED IN AS
                  </span>
                  <span className="dept-user-name da-user-name">
                  ...
                  {hasDropdown && (
                    <div className="dept-dropdown-menu da-dropdown-menu">
                      {item.items.map((subItem, sIdx) => {
                        const hasSideMenu =
                          Array.isArray(subItem.sideItems) &&
                          subItem.sideItems.length > 0;

                        return (
                          <div
                            key={subItem.id || sIdx}
                            className={`dept-dropdown-item da-dropdown-item ${hasSideMenu ? "has-side-menu has-side" : ""}`}
                          >
                            <a
                              href="#"
                            ...
                            >
                              ...
                              {hasSideMenu && (
                                <ChevronRight
                                  className="dash-icon-xxs ml-auto da-side-arrow"
                                  style={{
                                    width: "0.85rem",
                                    height: "0.85rem",
                                  }}
