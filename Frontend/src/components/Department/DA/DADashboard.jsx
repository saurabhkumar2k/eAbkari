...
export default function DADashbord({ onLogout, onNavigateHome }) {
  ...
  return (
    <div className="dept-dashboard">
      ...
      {activeSubMenu === "pull_application" || activeMenu === "pull_application" ? (
            ...
            <div className="welcome-banner-content">
              ...
              <div>
                ...
                <p className="welcome-subtext">
                  Excise Department, Govt. of NCT of Delhi — Official Application Scrutiny & Verification Portal
                </p>
              </div>
            </div>
            ...
            <div className="admin-details-grid">
              ...
              <div className="admin-details-list">
                ...
                <div className="admin-detail-row">
                  ...
                  <div className="admin-detail-info">
                    ...
                    <span className="admin-detail-value">Scrutiny Officer</span>
                  </div>
                </div>
                ...
                <div className="admin-detail-row">
                  ...
                  <div className="admin-detail-info">
                    ...
                    <span className="admin-detail-value">Dealing Assistant (DA)</span>
                  </div>
                </div>
                ...
                <div className="admin-detail-row">
                  ...
                  <div className="admin-detail-info">
                    ...
                    <span className="admin-detail-value" style={{ color: "#2563eb" }}>
              ...
              <div className="admin-login-info">
                ...
                <div className="admin-login-text-group">
                  ...
                  <span className="admin-login-time">Aug 4 2026 &nbsp;09:30 AM</span>
                </div>
              </div>
