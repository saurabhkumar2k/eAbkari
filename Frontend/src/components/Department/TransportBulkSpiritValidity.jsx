    ...
    <div className="tbs-container">
          ...
          <div className="tbs-header-row">
            ...
            <div className="tbs-brand-block">
              ...
              <div className="tbs-title-block">
                <h1>Transport Pass (Bulk Spirit) Validity Dashboard</h1>
            ...
            <div className="tbs-ribbon-wrapper">
              <div className="tbs-ribbon-container">
                ...
                <div className="tbs-ribbon-body">
                  <Layers />
                  Transport Pass (Bulk Spirit) Validity
                </div>
              </div>
            </div>
          ...
          <form onSubmit={handleSave}>
            ...
            <div className="tbs-validity-section">
              <h2 className="tbs-validity-title">
                <span>Transport Pass (Bulk Spirit) Validity : -</span>
              </h2>

              <div className="tbs-validity-grid">
                {/* 1. Distillery to FL Manufactory */}
                <div className="tbs-validity-card">
                  <span className="tbs-validity-label">Distillery to FL Manufactory</span>
                ...
                {/* 2. Distillery to CS Bottling Plant */}
                <div className="tbs-validity-card">
                  <span className="tbs-validity-label">Distillery to CS Bottling Plant</span>
                  <div className="tbs-validity-input-wrapper">
                    <input
                      type="number"
                      min="0"
                ...
                {/* 3. FL Manufactory to FL Manufactory */}
                <div className="tbs-validity-card">
                  <span className="tbs-validity-label">FL Manufactory to FL Manufactory</span>
                  <div className="tbs-validity-input-wrapper">
                    <input
                      type="number"
                      min="0"
                ...
                {/* 4. FL Manufactory to CS Bottling Plant */}
                <div className="tbs-validity-card">
                  <span className="tbs-validity-label">FL Manufactory to CS Bottling Plant</span>
                  <div className="tbs-validity-input-wrapper">
                    <input
                      type="number"
                      min="0"
                ...
                {/* 5. CS Bottling Plant to CS Bottling Plant */}
                <div className="tbs-validity-card">
                  <span className="tbs-validity-label">CS Bottling Plant to CS Bottling Plant</span>
                  <div className="tbs-validity-input-wrapper">
                    <input
                      type="number"
                      min="0"
                      max="720"
                      value={pathwayHours.csToCs}
                      onChange={(e) => setPathwayHours({ ...pathwayHours, csToCs: parseInt(e.target.value) || 0 })}
                      className="tbs-validity-input"
                    />
                    <span className="tbs-validity-unit">Hours</span>
                  </div>
                ...
                {/* 6. CS Bottling Plant to FL Manufactory */}
                <div className="tbs-validity-card">
                  <span className="tbs-validity-label">CS Bottling Plant to FL Manufactory</span>
                  <div className="tbs-validity-input-wrapper">
                    <input
                      type="number"
                      min="0"
                      max="720"
                      value={pathwayHours.csToFl}
                      onChange={(e) => setPathwayHours({ ...pathwayHours, csToFl: parseInt(e.target.value) || 0 })}
                      className="tbs-validity-input"
                    />
                    <span className="tbs-validity-unit">Hours</span>
                  </div>
                ...
                {/* 7. Distillery to Spl Section */}
                <div className="tbs-validity-card">
                  <span className="tbs-validity-label">Distillery to Spl Section</span>
                  <div className="tbs-validity-input-wrapper">
                    <input
                      type="number"
                      min="0"
                      max="720"
                      value={pathwayHours.distilleryToSpl}
                      onChange={(e) => setPathwayHours({ ...pathwayHours, distilleryToSpl: parseInt(e.target.value) || 0 })}
                      className="tbs-validity-input"
                    />
                    <span className="tbs-validity-unit">Hours</span>
                  </div>
                ...
                {/* 8. FL Manufactory to Spl Section */}
                <div className="tbs-validity-card">
                  <span className="tbs-validity-label">FL Manufactory to Spl Section</span>
                  <div className="tbs-validity-input-wrapper">
                    <input
                      type="number"
                      min="0"
                      max="720"
                      value={pathwayHours.flToSpl}
                      onChange={(e) => setPathwayHours({ ...pathwayHours, flToSpl: parseInt(e.target.value) || 0 })}
                      className="tbs-validity-input"
                    />
                    <span className="tbs-validity-unit">Hours</span>
                  </div>
                ...
                {/* 9. CS Bottling Plant to Spl Section */}
                <div className="tbs-validity-card">
                  <span className="tbs-validity-label">CS Bottling Plant to Spl Section</span>
                  <div className="tbs-validity-input-wrapper">
                    <input
                      type="number"
                      min="0"
                      max="720"
                      value={pathwayHours.csToSpl}
                      onChange={(e) => setPathwayHours({ ...pathwayHours, csToSpl: parseInt(e.target.value) || 0 })}
                      className="tbs-validity-input"
                    />
                    <span className="tbs-validity-unit">Hours</span>
                  </div>
              ...
              <table className="tbs-table">
                <thead>
                  <tr>
                    ...
                    <th style={{ textAlign: "center" }}>Distillery to FL Manufactory</th>
                    <th style={{ textAlign: "center" }}>Distillery to CS Bottling Plant</th>
                    <th style={{ textAlign: "center" }}>FL Manufactory to FL Manufactory</th>
                    <th style={{ textAlign: "center" }}>FL Manufactory to CS Bottling Plant</th>
                    <th style={{ textAlign: "center" }}>CS Bottling Plant to CS Bottling Plant</th>
                    <th style={{ textAlign: "center" }}>CS Bottling Plant to FL Manufactory</th>
                    <th style={{ textAlign: "center" }}>Distillery to Spl Section</th>
                    <th style={{ textAlign: "center" }}>FL Manufactory to Spl Section</th>
                    <th style={{ textAlign: "center" }}>CS Bottling Plant to Spl Section</th>
                ...
                <tbody>
                  {filteredRules.map((rule, idx) => (
                    ...
                    >
                      ...
                      <td style={{ textAlign: "center" }} className="tbs-cell-hours-indigo">{rule.hours.distilleryToSpl}h</td>
                      <td style={{ textAlign: "center" }} className="tbs-cell-hours-indigo">{rule.hours.flToSpl}h</td>
                      <td style={{ textAlign: "center" }} className="tbs-cell-hours-indigo">{rule.hours.csToSpl}h</td>
                      <td>
      ...
      <div className="tbs-callout">
        ...
        <div className="tbs-callout-content">
          <div className="tbs-callout-title">About Transport Pass (Bulk Spirit) Validity</div>
          <div className="tbs-callout-text">
            ...
            When a Bulk Spirit transport license is generated, the pipeline evaluates the source and destination districts of the licensee and applies the exact Hour limits specified on this dashboard. 
